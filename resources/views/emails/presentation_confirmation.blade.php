      ...
      <tr>
        <td valign="top" align="center">
          <table class="container" width="600" cellspacing="0" cellpadding="0" border="0">
            <tbody>
              <tr>
                <td style="padding:48px 0 30px 0; text-align: center; font-size: 14px; color: #4C83EE; font-weight: bold;">
                  Online Project Evaluation System
                </td>
              </tr>
              <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                          The next presentation session is scheduled as follows:
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0 0 16px 0;">
                          <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            <tbody>
                              ...
                              <tr>
                                <td style="padding: 0 0 8px; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                                  Status: <span style="font-weight: bold; color: green;">Confirmed</span>
                                </td>
                              </tr>
                              <tr>
                                <td style="padding: 0 0 8px; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
                              ...
                              <tr>
                                <td style="padding: 0 0 24px 0;">
                                  <a class="button" href="{{ $link }}" title="Online Project Evaluation System" style="width: 100%; background: #4C83EE; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Access Online Project Evaluation System</a>
                                </td>
                              </tr>
                            </tbody>
                          </table>
              ...
              <tr>
                <td style="padding: 24px 0 48px; font-size: 0px;">
                  <div class="outlook-group-fix" style="padding: 0 0 20px 0; vertical-align: top; display: inline-block; text-align: center; width:100%;">
                    <span style="padding: 0; font-size: 11px; line-height: 15px; font-weight: normal; color: #8B949F;">Online Project Evaluation System<br/>Department of Computer Applications</span>
                  </div>
                </td>
              </tr>
            </tbody>
